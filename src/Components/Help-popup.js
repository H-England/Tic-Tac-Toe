    ...
    <div className= "helpbox">
            <div className='helpcont'>
                ...
                <ul>
                    ...
                    <li>Step 4: Now it is time to choose a spot on the 3 by 3 grid to place your symbol. Once you have done that, it is the next person's turn. You can only choose empty spaces.</li>
